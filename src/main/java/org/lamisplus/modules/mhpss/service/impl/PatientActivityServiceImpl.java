...
import org.lamisplus.modules.mhpss.domain.dto.TimelineVm;
...
public class PatientActivityServiceImpl {
    private final BeanProvider beanProvider;
    private final PersonRepository patientRepository;

    public List<PatientActivity> getActivitiesFor(String patientId) {
        Person person = patientRepository.findByUuid(patientId).orElse(null);
        if (person != null) {
    ...
    @NotNull
    public List<TimelineVm> getTimelineVms(String patientId, boolean full) {
    ...
    public List<PatientActivity> getActivities(String id) {
